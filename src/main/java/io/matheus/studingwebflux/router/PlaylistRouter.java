package io.matheus.studingwebflux.router;

import io.matheus.studingwebflux.handler.PlaylistHandler;
...
public class PlaylistRouter {
    ...
    public RouterFunction<ServerResponse> router(PlaylistHandler handler) {
        return RouterFunctions
                .route(GET("/playlist").and(accept(MediaType.APPLICATION_JSON)), handler::finalAll)
